<div class="container mx-auto px-4 py-8">
    ...
    <div class_alias="mb-6 text-center">
        ...
        <input 
            ...
            type="text" 
            placeholder="Cari event berdasarkan nama, lokasi..." 
            class_alias="w-full max-w-lg px-4 py-2 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        >
    </div>
